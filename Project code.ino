...
#define TOKEN "BBFF-dEw81CuE9LxQgNJ7a2xvEnGcff5pl5" // Your Ubidots TOKEN
#define WIFINAME "TP-Link_FCA9" //Your SSID
#define WIFIPASS "4bottlevodka" // Your Wifi Pass
...
//  }
  ...
  ubidots.add("out", out);
  ubidots.add("now", now);
  ubidots.add("Light Status", relaystatus);
